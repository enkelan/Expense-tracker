...
const DialogOverlay = React.forwardRef(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ...
    style={{ backgroundColor: 'rgba(0, 0, 0, 0.8)' }} // Inline style for background color
    {...props}
  />
));
    ...
    <DialogPortal>
      ...
      <div className="fixed inset-0 flex items-center justify-center z-50">
        <DialogPrimitive.Content
          ref={ref}
          className={cn(
            'grid gap-4 border bg-background shadow-lg duration-200 sm:rounded-lg',
            className
          )}
          style={{ padding: '2rem', width: '500px' }} // Inline style for padding and width
          {...props}>
          {children}
